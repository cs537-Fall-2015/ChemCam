...
4) The GUI should be very self explanatory. There are 4 buttons:
  ...
  d) Save button is to save the commands, that you have editted to any where you want. There are of course checks in place to make sure you are not sending bogus command or incomplete commands list to the agent.
5) Last thing, please don't mess with <wherever-you-cloned>\ChemCamSimulator\src\chemcam\data\data.txt. That's the dummy data file that the program needs...
6) Report any bug you find to the next unlucky group that comes along...
