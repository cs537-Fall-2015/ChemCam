...
import chemcam.*;
import chemcam.src.ControllerRunnable;
import chemcam.src.RoverThread;
...
public class ControllerPanel extends javax.swing.JPanel {
					...
					try {
						while (true) {
							...
							ObjectOutputStream oos = new ObjectOutputStream(
									getRunnableServerSocket().getSocket().getOutputStream());
		...
		jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel2Layout.createSequentialGroup()
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jComboBox1, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addComponent(jButton1).addComponent(jButton2).addComponent(jCheckBox1)).addGap(2, 2, 2))
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
						.addComponent(jButton3).addComponent(jButton4).addContainerGap()));
				...
				controller = new ControllerRunnable(9011, null) {
					...
					public void run() {
						try {
							...
							ObjectInputStream ois = new ObjectInputStream(
									getRunnableSocket().getSocket().getInputStream());
	...
	private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton3ActionPerformed
		final JSONObject commandsJSON = new JSONObject();
		final String[] commandList = jTextArea2.getText().split("\n");
		ControllerRunnable controller = null;
		FileWriter fw;
